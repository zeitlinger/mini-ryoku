...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_split_3x5_2(
                          KC_ESC,                 KC_P,                 KC_M,              KC_LSFT, KC_NO, KC_NO,              KC_LSFT,        QK_REPEAT_KEY,    QK_ALT_REPEAT_KEY,             OSL(_FN),
	...
	[_RIGHT] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, KC_NO, KC_NO,           S(KC_LSFT),     S(QK_REPEAT_KEY), S(QK_ALT_REPEAT_KEY),                KC_NO,
	...
	[_RMODS] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, KC_NO, KC_NO,              KC_LSFT,        QK_REPEAT_KEY,    QK_ALT_REPEAT_KEY,                KC_NO,
