...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_split_3x5_2(KC_F8, KC_F7, KC_F6, KC_F5, KC_NO, KC_NO, KC_EXLM, KC_LPRN, KC_RPRN, KC_EQUAL, KC_F4, LALT_T(KC_F3), LCTL_T(KC_F2), LSFT_T(KC_F1), KC_NO, KC_NO, RSFT_T(KC_SEMICOLON), RCTL_T(KC_LEFT_BRACKET), LALT_T(KC_RIGHT_BRACKET), KC_BACKSLASH, KC_F12, KC_F11, KC_F10, KC_F9, KC_NO, KC_NO, KC_GRAVE, KC_LCBR, KC_RCBR, KC_AMPR, KC_NO, KC_NO, KC_TRNS, KC_TRNS),
