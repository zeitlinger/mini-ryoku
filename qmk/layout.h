...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x5_2(
            KC_SLASH, KC_W, KC_M, KC_F, KC_NO, KC_NO, KC_Y, KC_O, KC_U, KC_MINUS,
            LT(8,KC_R), LALT_T(KC_S), LCTL_T(KC_T), LSFT_T(KC_H), KC_NO, KC_NO, RSFT_T(KC_N), RCTL_T(KC_A), LALT_T(KC_I), KC_L,
            LT(7,KC_B), KC_C, KC_G, KC_D, KC_NO, KC_NO, KC_P, RALT(KC_QUOTE), LT(6,KC_COMMA), LT(4,KC_DOT),
	...
	[3] = LAYOUT_split_3x5_2(
            ...
            KC_INS, KC_9, KC_8, KC_7, KC_NO, KC_NO, KC_HOME, KC_BSPC, KC_DEL, KC_END,
	...
	[5] = LAYOUT_split_3x5_2(
            ...
            KC_NO, KC_LALT, LCTL_T(KC_BTN2), LSFT_T(KC_BTN1), KC_NO, KC_NO, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R,
