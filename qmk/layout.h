...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_X, KC_L, KC_D, KC_P, KC_W, KC_Y, KC_K, KC_O, KC_U, KC_Z, KC_N, KC_R, KC_T, KC_S, KC_G, KC_M, KC_H, KC_E, KC_I, KC_A, KC_LALT, KC_LCTL, KC_LSFT, KC_C, KC_V, KC_B, KC_F, KC_RSFT, KC_RCTL, KC_LALT, KC_SPC, MO(2), MO(3), MO(1)),
