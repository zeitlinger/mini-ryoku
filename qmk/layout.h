...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x5_2(
            ...
            LT(8,KC_B), KC_C, KC_G, KC_D, KC_NO, KC_NO, KC_P, RALT(KC_QUOTE), LT(7,KC_COMMA), LT(4,KC_DOT),
                            MO(2), KC_SPC, KC_E, LT(3,KC_BSPC)),
	[1] = LAYOUT_split_3x5_2(
            KC_SLASH, KC_W, KC_M, KC_F, KC_NO, KC_NO, KC_Y, KC_O, KC_U, KC_MINUS,
            KC_R, KC_LALT, KC_LCTL, KC_LSFT, KC_NO, KC_NO, KC_RSFT, KC_RCTL, KC_LALT, KC_L,
            LT(8,KC_B), KC_C, KC_G, KC_D, KC_NO, KC_NO, KC_P, RALT(KC_QUOTE), LT(7,KC_COMMA), LT(4,KC_DOT),
                            MO(2), KC_SPC, KC_E, KC_TAB),
	[2] = LAYOUT_split_3x5_2(
            KC_SLASH, KC_W, KC_M, KC_F, KC_NO, KC_NO, KC_Y, KC_O, KC_U, KC_MINUS,
            LT(9,KC_R), LALT_T(KC_S), LCTL_T(KC_T), LT(2,KC_H), KC_NO, KC_NO, LT(2,KC_N), RCTL_T(KC_A), LALT_T(KC_I), KC_L,
            LT(8,KC_B), KC_C, KC_G, KC_D, KC_NO, KC_NO, KC_P, RALT(KC_QUOTE), LT(7,KC_COMMA), LT(4,KC_DOT),
                            MO(2), KC_SPC, KC_E, LT(3,KC_BSPC)),
