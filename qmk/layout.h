...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_split_3x5_2(
            KC_NO, KC_F6, KC_F5, KC_F4, KC_NO, KC_NO, KC_NO, TG(5), MO(7), KC_NO,
	...
	[4] = LAYOUT_split_3x5_2(
            KC_NO, KC_6, KC_5, KC_4, KC_NO, KC_NO, ALGR(KC_GRV), KC_MINUS, KC_EQUAL, KC_NO,
            KC_3, ALT_T(KC_2), SFT_T(KC_1), CTL_T(KC_0), KC_NO, KC_NO, CTL_T(ALGR(KC_QUOTE)), SFT_T(KC_LEFT_BRACKET), ALT_T(KC_RIGHT_BRACKET), KC_BACKSLASH,
            KC_NO, KC_9, KC_8, KC_7, KC_NO, KC_NO, KC_SEMICOLON, QK_ALT_REPEAT_KEY, KC_EXLM, KC_SLASH,
                            KC_NO, KC_NO, KC_NO, KC_NO),
	...
	[7] = LAYOUT_split_3x5_2(
            ...
            DT_DOWN, KC_MPRV, KC_MNXT, KC_MPLY, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                            KC_NO, KC_NO, KC_NO, KC_NO),
};
