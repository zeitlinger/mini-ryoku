...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_split_3x5_2(
                          KC_ESC,                 KC_W,                 KC_M,               KC_SPC, KC_NO, KC_NO,              KC_LGUI, LT(_SYM,QK_REPEAT_KEY), LT(_FN,_TAP_C_ALGRKC_QUOTE),                KC_NO,
	...
	[_LEFT] = LAYOUT_split_3x5_2(
                       S(KC_ESC),              S(KC_W),              S(KC_M),            S(KC_SPC), KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
                         ...
                         KC_UNDS,              S(KC_F),              S(KC_L),              S(KC_D), KC_NO, KC_NO, SFT_T(_TAP_C_ALGRKC_Y), CTL_T(_TAP_C_ALGRKC_P),       ALT_T(KC_LSFT),                KC_NO,
                                     S(MO(_NAV)),              S(KC_R),               KC_SPC,                KC_NO),
	[_RIGHT] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, KC_NO, KC_NO,           S(KC_LGUI),              KC_EXLM,    ALGR(S(KC_QUOTE)),                KC_NO,
	...
	[_RMODS] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, KC_NO, KC_NO,              KC_LGUI,        QK_REPEAT_KEY,       ALGR(KC_QUOTE),                KC_NO,
	...
	[_SYM] = LAYOUT_split_3x5_2(
                           KC_NO,              KC_LABK,              KC_RABK,                KC_NO, KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
                           KC_AT,              KC_LPRN,              KC_RPRN,              KC_ASTR, KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
                         KC_PERC,              KC_AMPR,              KC_HASH,        ALGR(KC_TILD), KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
