...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(KC_DLR, KC_LCBR, KC_RCBR, KC_PLUS, KC_AT, KC_AMPR, KC_J, KC_LBRC, KC_RBRC, KC_Q, KC_COLN, KC_LPRN, KC_RPRN, KC_DQUO, KC_LGUI, KC_GRV, KC_EQL, KC_COMM, KC_DOT, KC_QUOT, KC_LALT, KC_LCTL, KC_LSFT, KC_UNDS, KC_ASTR, KC_HASH, KC_MINS, KC_SCLN, KC_SLSH, KC_BSLS, MO(4), MO(5), KC_TRNS, KC_TRNS),
