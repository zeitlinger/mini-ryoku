...
#define _HANDLER_DOT_SPC LT(_MED,DOT_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_split_3x5_2(
                          KC_ESC,                 KC_P,                 KC_M,                 KC_K, KC_NO, KC_NO,                 KC_Z,        QK_REPEAT_KEY,    QK_ALT_REPEAT_KEY,                KC_NO,
	...
	[_LEFT] = LAYOUT_split_3x5_2(
                       S(KC_ESC),              S(KC_P),              S(KC_M),              S(KC_K), KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
                         S(KC_S),              S(KC_C),              S(KC_N),              S(KC_T), KC_NO, KC_NO,        LT(_NUM,KC_0),     LT(_MED,DOT_SPC),                KC_NO,                KC_NO,
	...
	[_RIGHT] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, KC_NO, KC_NO,              S(KC_Z),     S(QK_REPEAT_KEY), S(QK_ALT_REPEAT_KEY),                KC_NO,
                           KC_NO,                KC_NO,        LT(_UML,KC_8),       LT(_CASE,KC_9), KC_NO, KC_NO,              S(KC_A),              S(KC_E),              S(KC_I),              S(KC_H),
	...
	[_LMODS] = LAYOUT_split_3x5_2(
                          KC_ESC,                 KC_P,                 KC_M,                 KC_K, KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
