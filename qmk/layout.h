...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x5_2(KC_TRNS, LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LT(2,KC_COMM), KC_L, KC_D, KC_C, KC_TRNS, KC_TRNS, LT(7,KC_ENT), KC_O, KC_U, LT(3,KC_DOT), KC_N, KC_R, KC_T, KC_S, KC_TRNS, KC_TRNS, KC_H, KC_E, KC_I, KC_A, LT(1,KC_SPC), MO(2), MO(3), LT(5,KC_BSPC)),
