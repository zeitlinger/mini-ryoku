...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(
            KC_SLASH, KC_W, KC_M, KC_F, KC_NO, KC_NO, KC_Y, KC_O, KC_U, KC_MINUS,
            KC_R, LALT_T(KC_S), LSFT_T(KC_T), LCTL_T(KC_H), KC_NO, KC_NO, RCTL_T(KC_N), RSFT_T(KC_A), LALT_T(KC_I), KC_L,
            LT(7,KC_B), KC_C, KC_G, KC_D, KC_NO, KC_NO, KC_P, RALT(KC_QUOTE), LT(6,KC_COMMA), LT(4,KC_DOT),
                            MO(2), KC_SPC, KC_E, KC_TAB),
	[2] = LAYOUT_split_3x5_2(
            KC_SLASH, KC_W, KC_M, KC_F, KC_NO, KC_NO, KC_Y, KC_O, KC_U, KC_MINUS,
            LT(8,KC_R), LALT_T(KC_S), LSFT_T(KC_T), LCTL_T(KC_H), KC_NO, KC_NO, RCTL_T(KC_N), RSFT_T(KC_A), LALT_T(KC_I), KC_L,
            LT(7,KC_B), KC_C, KC_G, KC_D, KC_NO, KC_NO, KC_P, RALT(KC_QUOTE), LT(6,KC_COMMA), LT(4,KC_DOT),
                            MO(2), KC_SPC, KC_E, KC_SPC),
	[3] = LAYOUT_split_3x5_2(
            KC_NO, KC_6, KC_5, KC_NO, KC_NO, KC_NO, KC_ESC, KC_PGUP, KC_PGDN, KC_NO,
            KC_4, LALT_T(KC_3), LSFT_T(KC_2), LCTL_T(KC_1), KC_NO, KC_NO, RCTL_T(KC_LEFT), RSFT_T(KC_UP), LALT_T(KC_DOWN), KC_RIGHT,
	...
	[4] = LAYOUT_split_3x5_2(
            ...
            KC_F4, KC_F3, KC_F2, KC_F1, KC_NO, KC_NO, KC_RCTL, KC_RSFT, KC_LALT, KC_NO,
            KC_F10, KC_F9, KC_F8, KC_F7, KC_NO, KC_NO, KC_RCTL, KC_RSFT, KC_LALT, KC_NO,
                            KC_NO, KC_F11, KC_F12, KC_NO),
	[5] = LAYOUT_split_3x5_2(
            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN3, KC_BTN1, KC_BTN2, KC_NO,
            KC_NO, KC_LALT, LSFT_T(KC_BTN2), LCTL_T(KC_BTN1), KC_NO, KC_NO, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R,
	...
	[7] = LAYOUT_split_3x5_2(
            ...
            KC_NO, LALT_T(KC_LALT), LSFT_T(LSFT(KC_UNDO)), LCTL_T(LCTL(KC_AGAIN)), KC_NO, KC_NO, RALT(KC_GRV), RALT(KC_DQUO), KC_EQUAL, KC_PIPE,
