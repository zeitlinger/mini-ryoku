...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_split_3x5_2(
                          KC_ESC,                 KC_W,                 KC_M,               KC_SPC, KC_NO, KC_NO,              KC_LGUI, LT(_SYM,QK_ALT_REPEAT_KEY), LT(_FN,QK_REPEAT_KEY),                KC_NO,
	...
	[_RMODS] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, KC_NO, KC_NO,              KC_LGUI,    QK_ALT_REPEAT_KEY,        QK_REPEAT_KEY,                KC_NO,
