...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x5_2(KC_SLASH, KC_W, KC_M, KC_F, KC_NO, KC_NO, KC_Y, KC_O, KC_U, KC_MINUS, KC_R, KC_S, KC_T, KC_H, KC_NO, KC_NO, KC_N, KC_A, KC_I, KC_L, LT(5,KC_B), LT(4,KC_C), KC_G, KC_D, KC_NO, KC_NO, KC_P, KC_QUOTE, LT(5,KC_COMMA), LT(3,KC_DOT), MO(1), KC_SPC, KC_E, LT(2,KC_BSPC)),
