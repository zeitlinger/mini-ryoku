...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_split_3x5_2(KC_NO, LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_L, KC_D, KC_G, KC_NO, KC_NO, KC_F, KC_O, KC_U, KC_NO, KC_N, KC_R, KC_T, KC_S, KC_NO, KC_NO, KC_H, KC_E, KC_I, KC_A, KC_SPC, KC_LSFT, TT(14), MO(1)),
	[1] = LAYOUT_split_3x5_2(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_K, KC_B, KC_Y, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_P, KC_M, KC_W, KC_C, KC_NO, KC_NO, MO(2), MO(3), MO(4), KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
	...
	[4] = LAYOUT_split_3x5_2(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_INS, KC_DEL, KC_PSCR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_ESC, KC_LGUI, KC_BSPC, KC_ENT, KC_NO, KC_NO, KC_RCTL, KC_LALT, KC_TRNS, KC_RSFT, KC_TAB, KC_NO, KC_NO, KC_NO),
	...
	[14] = LAYOUT_split_3x5_2(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LALT, KC_LCTL, KC_BTN3, KC_NO, KC_NO, KC_BTN1, KC_WH_U, KC_WH_D, KC_NO, KC_LSFT, KC_WH_L, KC_WH_R, KC_BTN2, KC_NO, KC_NO, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
